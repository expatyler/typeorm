                ...
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        newTable.columns
                            ...
                            upQueries.push(new Query("ALTER TYPE " + _this.buildEnumName(oldTable, column) + " RENAME TO " + _this.buildEnumName(newTable, column, false)));
                            downQueries.push(new Query("ALTER TYPE " + _this.buildEnumName(newTable, column) + " RENAME TO " + _this.buildEnumName(oldTable, column, false)));
                        });
                        return [4 /*yield*/, this.executeQueries(upQueries, downQueries)];
                    case 4:
                        _b.sent();
