                ...
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        newTable.columns
                            ...
                            upQueries.push(new Query_1.Query("ALTER TYPE " + _this.buildEnumName(oldTable, column) + " RENAME TO " + _this.buildEnumName(newTable, column, false)));
                            downQueries.push(new Query_1.Query("ALTER TYPE " + _this.buildEnumName(newTable, column) + " RENAME TO " + _this.buildEnumName(oldTable, column, false)));
                        });
                        return [4 /*yield*/, this.executeQueries(upQueries, downQueries)];
                    case 4:
                        _b.sent();
                    ...
                    case 6:
                        if (oldColumn.name !== newColumn.name) {
                            ...
                            if (oldColumn.type === "enum" || oldColumn.type === "simple-enum") {
                                upQueries.push(new Query_1.Query("ALTER TYPE " + this.buildEnumName(table, oldColumn) + " RENAME TO " + this.buildEnumName(table, newColumn, false)));
                                downQueries.push(new Query_1.Query("ALTER TYPE " + this.buildEnumName(table, newColumn) + " RENAME TO " + this.buildEnumName(table, oldColumn, false)));
                            }
                            // rename column primary key constraint
                        ...
                        if ((newColumn.type === "enum" || newColumn.type === "simple-enum")
                            ...
                            // rename old ENUM
                            upQueries.push(new Query_1.Query("ALTER TYPE " + enumName + " RENAME TO " + oldEnumNameWithoutSchema));
                            downQueries.push(new Query_1.Query("ALTER TYPE " + oldEnumName + " RENAME TO " + enumNameWithoutSchema));
                            // create new ENUM
